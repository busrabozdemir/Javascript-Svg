...
function hideClasses() { //gizle tüm sınıf animasyon içerir
    selectedElement = -1;
...
function showClasses() { //tüm sınıfta animasyon göster
    selectedElement = len;
    var _elements = document.getElementsByClassName("animation");
    for (var i = 0; i < _elements.length; i++)
...
function showNextClass() { //gizle tüm sınıf animasyon içerir     
...
function hidePreviousClass() { //gizle tüm sınıf animasyonunu
